---
name: bab4-re-agent-skill
description: Menulis Bab 4.1 (Analisis Kebutuhan Sistem) laporan TA INSPIRA dalam format LaTeX, berdasarkan output nyata dari Requirement Engineering Agent — termasuk hasil wawancara, user stories, dan tabel prioritisasi AHP/WSJF. Aktifkan skill ini saat output RE Agent sudah tersedia dan kamu ingin menyusun subbab 4.1.
---
