---
name: bab4-architecture-agent-skill
description: Menulis Bab 4.2 (Perancangan Sistem) laporan TA INSPIRA dalam format LaTeX, berdasarkan output nyata dari Architecture Agent — termasuk spesifikasi arsitektur teks, diagram UML (use case, sequence, class), ERD, dan arsitektur komponen. Aktifkan skill ini saat output Architecture Agent sudah tersedia dan kamu ingin menyusun subbab 4.2.
---
